...
def parse_options_open(return_parser=False):
    # New CLI parser
    ...
    #data_group.add_argument('--total_surf_num', type = int, default = 20000000)
    data_group.add_argument('--total_surf_num', type = int, default = 1000000)
    ...
    data_group.add_argument('--box_uniform_num', type = int, default = 500)
    #data_group.add_argument('--box_uniform_num', type = int, default = 200)
    data_group.add_argument('--box_surf_num', type = int, default = 500)
    data_group.add_argument('--box_bdr_num', type = int, default = 500)
    data_group.add_argument('--jitter_delta_scale', type = float, default = 0.1)
    data_group.add_argument('--merge_extend_length', type = float, default = 0.03)
    #data_group.add_argument('--merge_extend_length', type = float, default = 0.0)
    ...
    optim_group.add_argument('--mile_stone', type = int, nargs = 2, default = [700, 850],
    #optim_group.add_argument('--mile_stone', type = int, nargs = 2, default = [1000, 1250],
    #optim_group.add_argument('--mile_stone', type = int, nargs = 2, default = [270, 285],
    #optim_group.add_argument('--mile_stone', type = int, nargs = 2, default = [80, 90],
                             help = 'Mile stones for lr decay.')
 
    # Arguments for training
    train_group = parser.add_argument_group('trainer')
    #train_group.add_argument('--epochs', type = int, default = 1500,                
