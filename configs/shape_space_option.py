...
def parse_options_ss(return_parser=False):
    # New CLI parser
    ...
    data_group.add_argument('--batch_spatial_num', type = int, default = 60000)
    data_group.add_argument('--batch_merge_num', type = int, default = 0)
    data_group.add_argument('--batch_surf_num', type = int, default = 120000)
    data_group.add_argument('--batch_bdr_num', type = int, default = 0)
    data_group.add_argument('--batch_jitter_surf_num', type = int, default = 60000)
    ...
    optim_group.add_argument('--mile_stone', type = int, nargs = 2, default = [150000, 175000],
                             help = 'Mile stones for lr decay.')
 
    # Arguments for training
    train_group = parser.add_argument_group('trainer')             
    train_group.add_argument('--epochs', type = int, default = 200000,                                          
    ...
    train_group.add_argument('--model_path', type = str, default = '_results/shape_space', 
    ...
    loss_group.add_argument('--merge_surf', type = float, default = 0)
